                                                ...
                                                if (!r.ok) {
                                                    if (r.status === 401 || r.status === 403) {
                                                        Swal.fire({
                                                            ...
                                                            position: 'top',
                                                            icon: 'warning',
                                                            title: 'Akses ditolak atau sesi berakhir. Silakan masuk kembali.',
                                                        ...
                                                        Swal.fire({
                                                            ...
                                                            position: 'top',
                                                            icon: 'error',
                                                            title: 'Gagal memuat riwayat upload.',
                                                            showConfirmButton: false,
                                                            timer: 3500,
                                                            timerProgressBar: true
                                                        });
                                                        ...
                                                        .then(resp => {
                                                            if (resp.ok) {
                                                                ...
                                                                Swal.fire({
                                                                    ...
                                                                    position: 'top',
                                                                    icon: 'error',
                                                                    title: 'Gagal menghapus riwayat: ' + (resp.msg || ''),
                                                                    showConfirmButton: false,
                                                                    timer: 3500,
                                                                    timerProgressBar: true
                                                                });
                    ...
                    .then(data => {
                        ...
                        data.data.forEach(row => {
                            ...
                            if (statusValue === 1) {
                                ...
                                statusBadge = '<span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">Done</span>';
                            } else if (statusValue === 4) {
                                statusBadge = '<span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-purple-100 text-purple-800">Revision</span>';
                            } else {
                            ...
                            switch (row.jenis_premi) {
                                case "1":
                                    jenisPremiName = "JHT Regular";
                                    break;
                                case "2":
                                    jenisPremiName = "JHT Topup";
                                    break;
                                case "3":
                                    jenisPremiName = "PKP Regular";
                                    break;
                            }
                            tr.innerHTML = `
                                <td class="px-4 py-3 text-sm font-medium text-gray-900">${row.periode || '-'}</td>
                                <td class="px-4 py-3 text-sm text-gray-600">${jenisPremiName || '-'}</td>
